...
import './App.css';
import logo from './logo.svg'; // Assuming this is still used somewhere
import controlVImage from './assets/download.png'; // Import the image
import templeImage from './assets/lc.png'; // Import the new image
import image1 from './assets/lc.png'; // Import the first image
import image2 from './assets/lc.png'; // Import the second image
import image3 from './assets/lc.png'; // Import the third image
    ...
    <div className="App">
      ...
      <div className="reversed-content">
        ...
        <div className="text-container">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque et urna nec tortor tristique posuere.</p>
        </div>
      </div>
